...
const totalRaisedd = GAMES_JSON.reduce((sum, game) => sum + game.pledged, 0);
const totalGames = GAMES_JSON.length;
const unfundedStatement = `${unfundedGamesCount} ${unfundedGamesCount === 1 ? 'game is' : 'games are'} currently unfunded`;

const infoString = `A total of $${totalRaisedd.toLocaleString()} has been raised for ${totalGames} games, of which ${unfundedStatement}.`;
...
// For the second most funded game
